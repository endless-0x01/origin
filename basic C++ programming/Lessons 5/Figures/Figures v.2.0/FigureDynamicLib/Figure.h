...
public:
	...
	FIGURELIBRARY_API int get_numbers_of_sides() const;

	FIGURELIBRARY_API std::string get_of_name() const;

	FIGURELIBRARY_API virtual void data_sides() const {};

	FIGURELIBRARY_API virtual void print_info() const
	{
