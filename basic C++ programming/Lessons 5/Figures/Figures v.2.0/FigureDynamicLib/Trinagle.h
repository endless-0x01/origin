...
protected: // Функция проверки фигуры
	FIGURELIBRARY_API virtual bool check_figure() const;
public:
	FIGURELIBRARY_API Triangle(std::string name = "Треугольник") : Figure(3, name) {}
	FIGURELIBRARY_API Triangle(sides_ sides, corners_ corners, std::string name);
