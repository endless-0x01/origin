...
<<<<<<< HEAD
			std::cout << "Р”РёРЅР°РјРёС‡РµСЃРєРёР№ РјР°СЃСЃРёРІ: ";
=======
...
<<<<<<< HEAD
			std::cout << "РЈРґР°Р»РёС‚СЊ РїРµСЂРІС‹Р№ СЌР»РµРјРµРЅС‚?: ";
			std::string str;
			std::cin >> str;
			if (str == "РЅРµС‚") {
=======
...
>>>>>>> f612aba41e0ae7c5bd9a6d1bfb4099ac4dfb73a0
			...
			{
<<<<<<< HEAD
				std::cout << "РЈРґР°Р»СЏС‚СЊ РЅРµС‡РµРіРѕ, РІР°С€ РјР°СЃСЃРёРІ РїСѓСЃС‚!" << std::endl;
=======
...
<<<<<<< HEAD
		std::cout << "РЎРїР°СЃРёР±Рѕ, РІР°С€ РјР°СЃСЃРёРІ: ";
=======
